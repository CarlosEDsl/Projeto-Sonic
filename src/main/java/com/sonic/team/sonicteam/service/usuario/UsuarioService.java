...
//TODO: Retirar os repositorys quando houver os services deles
@Service
public class UsuarioService {
    ...
    public UsuarioResponseDTO atualizar(String cpfPath, UsuarioRequestDTO dto) {
        // Validações básicas do DTO já foram feitas pelo @Valid no controller
        ...
        usuario.setCpf(cpf); // Garante que o CPF permanece normalizado
        usuario.setCategoria(categoria);
        usuario.setCurso(curso);
